...
public class SortedSetExercisesUserClassNoValEqualZeroComparatorTest {
    ...
    public void sortedSetWithComparatorForUserWithNoValEqualZero(){
        ...
        SortedSet<User> userSortedList = new TreeSet<User>(new UserComparatorDisallowDupesNoValEqualZero());
        ...
        Assert.assertEquals( 2, userSortedList.size(),"Mr Beer could not be added");
    }
