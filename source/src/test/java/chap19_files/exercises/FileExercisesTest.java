...
public class FileExercisesTest {
    ...
    public void createTempFileVaryTheParameters() throws IOException {
        ...
        Assert.assertEquals(temp1.exists(), true);
        Assert.assertEquals(temp2.exists(), true);
    ...
    public void writeATestToCheckCanonicalConversion() throws IOException {
        ...
        Assert.assertEquals(trimOsStuff(
        ...
        Assert.assertEquals(absolute1.getAbsolutePath().contains(".."), true);
        Assert.assertEquals(absolute2.getAbsolutePath().contains(".."), true);
    }
    ...
    public void checkThatTheTempDirectoryIsADirectory(){
        ...
        Assert.assertEquals(tempDir.isDirectory(), true);
        Assert.assertEquals(tempDir.isFile(), false);
    }
    ...
    public void spaceMethods() throws IOException {
        ...
        Assert.assertEquals(outputFile.length(), expectedFileSize(5));
